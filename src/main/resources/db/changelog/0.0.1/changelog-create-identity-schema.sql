...
--changeset DmitryBuchnev:create-identity-schema
--comment create new schema
create schema identity;
--rollback drop schema identity;

--changeset DmitryBuchnev:create-identity-user_accounts-table
...
--changeset DmitryBuchnev:create-identity-user_roles-table
...
--changeset DmitryBuchnev:create-identity-user_accounts_roles-table
...
--changeset DmitryBuchnev:add-user_accounts_roles-table-constraints
...
--rollback after table identity.user_account_roles drop constraint user_accounts_roles__user_roles__fk;
--rollback after table identity.user_account_roles drop constraint user_accounts_roles__user_accounts__fk;
--rollback after table identity.user_account_roles drop constraint user_accounts_roles_unique;

--changeset DmitryBuchnev:add-data-to-user_roles-table
